...
public class Memo extends JFrame {
	...
	FileNameExtensionFilter filter = new FileNameExtensionFilter(",txt", "jpg", "gif"); // description,......확장자
...
class CustomActionListener implements ActionListener {
	...
	public CustomActionListener(Memo memo) {
		this.memo = memo;
		cFile = new CustomFile(this.memo);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		/** OPEN */
		else if (e.getSource() == memo.mntmOpen) {// 오픈 눌렀을시
			try {
				cFile.fileLoad();
			} catch (Exception e3) {
				System.out.println("오픈 선택 안함");
			}
		}
