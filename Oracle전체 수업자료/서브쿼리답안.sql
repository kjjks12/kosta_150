...
ex11) 각 부서의 어떤 평균 급여보다 급여를 많이 
      받는 사원의 정보를 검색
       ...
       1) 부서별 평균 급여를 구한다.
       SELECT dept_id,  AVG(sal) 평균급여 FROM subEMP
       where dept_id is not null
       group BY dept_id;
              
              
       2) 나온 평균급여들중의 최대값보다 커야한다.
